  ...
  <div class="inputs">
    ...
    >
      ...
      <el-form-item required>
        <el-select v-model="sendMessage.value" 
        filterable 
        placeholder="최근발신번호" 
    ...
    <div class="validation-box">
      ...
      <span class="check-bytes" :style="{color: isRed}">{{byteLength}} / {{totalByteLength}} Bytes</span>
    </div>
    <div class="button-box">
      <el-button type="primary" round disabled size="small">미리보기</el-button>
      <el-button type="primary" round disabled size="small">예약전송</el-button>
      <el-button type="primary" round size="small" @click="sendBtn">즉시전송</el-button>
...
export default Vue.extend ({
  ...
  methods: {
    ...
    sendBtn() {
      ...
      if(this.sendMessage.textarea === null || this.sendMessage.textarea === '') {
        alert("내용을 입력해주세요");
        return false
      }
